    ...
    <div>
      ...
      <div className="detail">
        <div className="detail-box">
          {props.filterBaseCode === 'All' && <h1 className="fs-normal fc-grey">국가별 합계</h1>}
          {props.filterBaseCode === 'USD' && <h1 className="fs-normal fc-grey">USD 합계</h1>}
          {props.filterBaseCode === 'EUR' && <h1 className="fs-normal fc-grey">EUR 합계</h1>}
          {props.filterBaseCode === 'GBP' && <h1 className="fs-normal fc-grey">GBP 합계</h1>}
          {props.filterBaseCode === 'CNY' && <h1 className="fs-normal fc-grey">CNY 합계</h1>}
          {props.filterBaseCode === 'JPY' && <h1 className="fs-normal fc-grey">JPY 합계</h1>}
