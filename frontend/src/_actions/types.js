...
export const GET_CHART_DATES = "get_chart_dates";
export const GET_CHART_CODE = "get_chart_code";
...
export const GET_PAST_KEYWORDS = "get_past_keywords";
export const GET_PAST_NEWS = "get_past_news";
export const GET_PAST_CURR_DATA = "get_past_curr_data";
