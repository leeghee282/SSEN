...
public class CNY {
    ...
    public void reportCurrentTime() {
        ...
        if (!regdate1.isEqual(regdate2)) {
            ...
            System.out.println("code : CNY" + ", buyPrice : " + price + ", regdate : " + liveCurrencyRes.getRegdate());
            ...
            // List<Double> targets = liveUpdateRepositorySupport.getTarget(liveCurrencyRes, currencyCategoryService.getCurrencyCategorybyCode("CNY").getUid());
            ...
            for (int i = 0; i < lurList.size(); i++) {
                ...
                str = s[1] + " CNY 환율 " + lurList.get(i).getBuyPrice() + ", "
                ...
                System.out.println(lurList.get(i).getRegdate() + " : 현재 환율" + lurList.get(i).getBuyPrice() + ", "
                        + lurList.get(i).getUserId() + "님의 CNY 목표 환율 "+lurList.get(i).getTargetPrice()+"원에 도달하였습니다.");
            }
            System.out.println("==============");
        }
    }
